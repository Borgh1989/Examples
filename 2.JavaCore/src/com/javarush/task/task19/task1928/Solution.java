...
public class Solution {
    ...
    public static void main(String... args) throws IOException {
        try (
                FileOutputStream outputStream = new FileOutputStream("c:/test/testFile.txt");
//                InputStream is = Solution.class.getClassLoader().getResourceAsStream("c:/test/testFile2.txt");
                InputStream is = new FileInputStream("c:/test/testFile2.txt");
        ) {
            ;
